function y = AEBL_outputs_Sheng_no_accel_terms(t,x,inputs_outputs,U,b,ah,M,beta,eta,E0,Df,K0,K1,K2,kappa,K_a,K_aM,K_q,K_qM,T_I,b1,b2,b3,b4,A1,A2,A3,A4,c_m0,c_n_alpha,TvL,alpha_ss,alpha_ds0,q0,alpha1_0,S1,S2,y0)

%% Effective AoA and pitch rate
alpha_bar = atan((U*sin(x(16))+x(13)*cos(x(16))-b*(1/2+ah)*x(14))/(U*cos(x(16))-x(13)*sin(x(16))));
alpha_bar_dot = 1/(tan(alpha_bar)^2+1)*(((U*x(14)*cos(x(16))-x(13)*x(14)*sin(x(16)))*(U*cos(x(16))-x(13)*sin(x(16)))+(U*sin(x(16))+x(13)*cos(x(16))-b*(1/2+ah)*x(14))*(U*x(14)*sin(x(16))+x(13)*x(14)*cos(x(16))))/(U*cos(x(16))-x(13)*sin(x(16)))^2);
...
%% Separation points
% Steady condition separation point based on effective AoA with gust (alpha_hat)
...
if abs(x(9))>=alpha_cr && so_i<alpha_cr 
    tv0 = t; 
end
